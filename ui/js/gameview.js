// https://github.com/citizenfx/fivem/blob/538f9cc8310391417fd025febae6d1efb9558bc5/ext/cfx-ui/src/app/app.component.ts
...
export const GameRender = (width, height) => {
	const canvas = document.createElement("canvas");
	canvas.style.display = "inline";
	canvas.width = width ?? window.innerWidth;
	canvas.height = height ?? window.innerHeight;

	return createGameView(canvas);
};